...
//	#endif
	...
	#define mLED2               LATCbits.LATC1

        #define mLED1Tris           TRISCbits.TRISC0
        #define mLED2Tris           TRISCbits.TRISC1

	/** S W I T C H *****************************************************/
	#define mInitAllSwitches()	TRISCbits.TRISC2 = INPUT_PIN;
	#define swProgram		PORTCbits.RC2
	#define mInitSwitch2()          TRISCbits.TRISC2 = INPUT_PIN;
	#define mDeInitSwitch2()        TRISCbits.TRISC2 = INPUT_PIN;
